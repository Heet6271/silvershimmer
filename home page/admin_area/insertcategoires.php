...
if(isset($_POST['insert_cat'])){
    ...
    $ssql="select * from `categories` where category_title='$category_title'";
...
<form action="" method="post" class="mb-2">
    ...
    <div class="input-group w-10 mb-2 m-auto">
        <input type="submit" class="bg-secondary text-light border-0 p-2 my-3" name="insert_cat" value="Insert Categories">

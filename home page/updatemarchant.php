...
$id=$_GET['updatemarchantid'];
$sql="select * from `marchant` where mid=$id";
...
if(isset($_POST['submit'])){
    ...
    $sql="update `marchant` set id=$id, mname='$mname', gstno='$gstno', cname='$cname', mobileno='$mobileno', address='$address' where id=$id";
    $result=mysqli_query($conn, $sql);
    if($result){

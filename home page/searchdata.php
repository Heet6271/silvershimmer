...
<?php include 'navbar.php' ?>
    ...
    if($result){
        ...
        <div class="jumbotron">
            ...
            <hr class="my-4">
            <a class="btn btn-dark btn-lg" href="labourbill.php" role="button">Back</a>
        </div>
    </div>';
    }
    ?>
    <div class="container my-5">
            <table class="table">
    <?php
    $sqll="select * from `givingoder` where id like '%$data%' or name like '%$data%' or workingtype like '%$data%'";
